...
class PerumahanRakyatImport implements ToCollection, WithHeadingRow
{
    /**
    ...
    */
    public function collection(Collection $collection)
    {
        ...
        foreach ($collection as $row){
            $tahun=$row['tahun'];
            $kode = $row['kode'];
            $data = PerumahanRakyatModel::firstOrNew(['kode' => $kode,'tahun'=>$tahun]);
            $data->kode = $row['kode'];
    ...
    $jumlahdata = DB::table('input_perumahan_rakyat')->count();
    $jumlahdiisi = DB::table('data_perumahan_rakyat')->where([['tahun',$tahunnya],['jumlah','!=',0]])->count();
    $namafile = 'Data Perumahan Rakyat & Kawasan Pemukiman';
    $pj = 'DPRKP';
