...
class DewanImport implements ToCollection, WithHeadingRow
{
    ...
    $jumlahdata = DB::table('input_sekertariat_dewan')->count();
        $jumlahdiisi = DB::table('data_sekertariat_dewan')->where([['tahun',$tahunnya],['jumlah','!=',0]])->count();
        $namafile = 'Data Sekertariat Dewan';
        $pj = 'SEKDPRD';
