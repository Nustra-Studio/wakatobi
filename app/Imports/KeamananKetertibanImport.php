...
class KeamananKetertibanImport implements ToCollection, WithHeadingRow
{
    ...
    $jumlahdata = DB::table('input_keamanan_ketertiban')->count();
    $jumlahdiisi = DB::table('data_keamanan_ketertiban')->where([['tahun',$tahunnya],['jumlah','!=',0]])->count();
    $namafile = 'Data ketenteraman & ketertiban';
    $pj = 'SATPOL PP & PMK, BPBD, BKBP';
