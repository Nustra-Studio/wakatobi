...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Kec. Kaledupa Selatan</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Data Kec. Kaledupa Selatan</h3>
                        <div class="card-tools">
                            <a href="{{url('data-kaledupa-selatan-import')}}">
                            ...
                            <table id="list-data" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Bentuk</th>
                                        @php
                                        $gettahun = DB::table('data_kaledupaselatan')
                                        ->groupby('tahun')
                                        ->orderby('id','asc')
                                        ->get();
                                        @endphp
                                ...
                                <tbody>
                                    ...
                                    $idua=1;
                                    $headdua =
                                    DB::table('input_kaledupaselatan')->where('header_satu',$row->header_satu)->groupBy('header_dua')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    @else
                                    @php
                                    $lastdata = DB::table('data_kaledupaselatan')
                                    ->where('kode',$rowdua->id)
                                    ->orderby('id','desc')
                                    ->limit(1)
                                    ->get();

                                    $alldata = DB::table('data_kaledupaselatan')
                                    ->where('kode',$rowdua->id)
                                    ->orderby('id','asc')
                                    ->get();
                                    @endphp
                                    ...
                                    $itiga=1;
                                    $headtiga =
                                    DB::table('input_kaledupaselatan')->where([['header_satu',$row->header_satu],['header_dua',$rowdua->header_dua]])->groupBy('header_tiga')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    $iempat=1;
                                    $headempat =
                                    DB::table('input_kaledupaselatan')->where([['header_satu',$row->header_satu],['header_dua',$rowdua->header_dua],['header_tiga',$rowtiga->header_tiga]])->orderby('id','asc')->get();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Hapus Data Kec. Kaledupa</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('/data-kaledupa-selatan/hapus')}}" method="POST" enctype="multipart/form-data">
