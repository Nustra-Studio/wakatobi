...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Pangan</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="table-responsive">
                            <table id="list-data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    @else
                                    @php
                                    $lastdata = DB::table('data_pangan')
                                    ->where('kode',$row->id)
                                    ->orderby('id','desc')
                                    ->limit(1)
                                    ->get();

                                    $alldata = DB::table('data_pangan')
                                    ->where('kode',$row->id)
                                    ->orderby('id','asc')
                                    ->get();
                                    @endphp
                                    ...
                                    $idua=1;
                                    $headdua =
                                    DB::table('input_pangan')->where('header_satu',$row->header_satu)->groupBy('header_dua')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    $itiga=1;
                                    $headtiga =
                                    DB::table('input_pangan')->where([['header_satu',$row->header_satu],['header_dua',$rowdua->header_dua]])->orderby('id','asc')->get();
                                    @endphp
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Hapus Data Pangan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('/pangan/hapus')}}" method="POST" enctype="multipart/form-data">
