            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">List Data Perdagangan</h3>
                        <div class="card-tools">
                            <a href="{{url('perdagangan-import')}}">
                            ...
                            <table id="list-data" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Bentuk</th>
                                        @php
                                        $gettahun = DB::table('data_perdagangan')
                                        ->groupby('tahun')
                                        ->orderby('id','asc')
                                        ->get();
                                        @endphp
                                ...
                                <tbody>
                                    ...
                                    $idua=1;
                                    $headdua =
                                    DB::table('input_perdagangan')->where('header_satu',$row->header_satu)->groupBy('header_dua')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    @else
                                    @php
                                    $lastdata = DB::table('data_perdagangan')
                                    ->where('kode',$rowdua->id)
                                    ->orderby('id','desc')
                                    ->limit(1)
                                    ->get();

                                    $alldata = DB::table('data_perdagangan')
                                    ->where('kode',$rowdua->id)
                                    ->orderby('id','asc')
                                    ->get();
                                    @endphp
                                    ...
                                    $itiga=1;
                                    $headtiga =
                                    DB::table('input_perdagangan')->where('header_dua',$rowdua->header_dua)->groupBy('header_tiga')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    $iempat=1;
                                    $headempat =
                                    DB::table('input_perdagangan')->where('header_tiga',$rowtiga->header_tiga)->orderby('id','asc')->get();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Hapus Perdagangan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('/perdagangan/hapus')}}" method="POST" enctype="multipart/form-data">
