...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Perumahan Rakyat & Kawasan Pemukiman</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Data Perumahan Rakyat & Kawasan Pemukiman</h3>
                        <div class="card-tools">
                            <a href="{{url('perumahan-rakyat-import')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Hapus Perumahan Rakyat & Kawasan Pemukiman</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('/perumahan-rakyat/hapus')}}" method="POST" enctype="multipart/form-data">
