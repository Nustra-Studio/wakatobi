            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">List Data Perencanaan Pembangunan</h3>
                        <div class="card-tools">
                            <a href="{{url('perencanaan-pembangunan-import')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Hapus Data Perencanaan Pembangunan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('/perencanaan-pembangunan/hapus')}}" method="POST" enctype="multipart/form-data">
