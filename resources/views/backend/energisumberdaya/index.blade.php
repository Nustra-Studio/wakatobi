...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Energi & Sumber Daya Mineral</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">List Data Energi & Sumber Daya Mineral</h3>
                        <div class="card-tools">
                            <a href="{{url('energi-dan-sumber-daya-mineral-import')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Hapus Data Energi & Sumber Daya Mineral</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('/energi-dan-sumber-daya-mineral/hapus')}}" method="POST" enctype="multipart/form-data">
