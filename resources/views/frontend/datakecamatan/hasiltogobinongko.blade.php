    ...
    <section class="text-center mb-0" style="padding-bottom:15%;">
        <div class="container text-left">
            <div class="rows" style="padding-top:10%;">
                <div class="col-12">
                <h2>Data Kec.Togo Binongko Tahun {{$tahunawal}} - {{$tahunakhir}}</h2>
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">List Data Kec.Togo Binongko</h3>
...
function tampilgrafik(kode, tahunawal, tahunakhir,text) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: '/togo-binongko/cari-grafik/' + kode + '/' + tahunawal + '/' + tahunakhir,
