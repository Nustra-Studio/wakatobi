        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-10">
                ...
                <section class="text-center mb-0" style="padding-bottom:15%;">
                    <div class="container">
                        <form method="get" action="{{url('profile-kecamatan/wangi-wangi-selatan/cari')}}">
                        {{csrf_field()}}
                            <h1 style="text-align:center;"> <i class="fa fa-search"></i> Cari Data Kec.Wangi-Wangi Selatan</h1>
                            <hr>
                            <div class="row">
