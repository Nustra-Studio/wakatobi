    ...
    <section class="text-center mb-0" style="padding-bottom:15%;">
        <div class="container text-left">
            <div class="rows" style="padding-top:10%;">
                <div class="col-12">
                <h2>Data Kec.Kaledupa Selatan Tahun {{$tahunawal}} - {{$tahunakhir}}</h2>
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">List Data Kec.Kaledupa Selatan</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary"
                                                onclick="tampilgrafik({{$rowdua->id}},{{$tahunawal}},{{$tahunakhir}},'{{$rowdua->header_dua}}s')">
...
function tampilgrafik(kode, tahunawal, tahunakhir,text) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: '/kaledupa-selatan/cari-grafik/' + kode + '/' + tahunawal + '/' + tahunakhir,
