    ...
    <section class="text-center mb-0" style="padding-bottom:15%;">
        <div class="container text-left">
            <div class="rows" style="padding-top:10%;">
                <div class="col-12">
                <h1>Data Kesehatan Tahun {{$tahunawal}} - {{$tahunakhir}}</h1>
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">List Data Kesehatan</h3>
                            ...
                            <table id="list-data" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Bentuk</th>
                                        @php
                                        $gettahun = DB::table('data_kesehatan')
                                ...
                                <tbody>
                                    ...
                                    $idua=1;
                                    $headdua =
                                    DB::table('input_kesehatan')->where('header_satu',$row->header_satu)->groupBy('header_dua')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    @else
                                    @php
                                    $lastdata = DB::table('data_kesehatan')
                                    ...
                                    $alldata = DB::table('data_kesehatan')
                                    ->where('kode',$rowdua->id)
                                    ->where([['tahun','>=',$tahunawal],['tahun','<=',$tahunakhir]])
                                    ->orderby('id','asc')
                                    ->get();
                                    ...
                                    $itiga=1;
                                    $headtiga =
                                    DB::table('input_kesehatan')->where([['header_satu',$row->header_satu],['header_dua',$rowdua->header_dua]])->groupBy('header_tiga')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    $iempat=1;
                                    $headempat =
                                    DB::table('input_kesehatan')->where([['header_satu',$row->header_satu],['header_dua',$rowdua->header_dua],['header_tiga',$rowtiga->header_tiga]])->groupBy('header_empat')->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    $ilima=1;
                                    $headlima =
                                    DB::table('input_kesehatan')->where([['header_satu',$row->header_satu],['header_dua',$rowdua->header_dua],['header_tiga',$rowtiga->header_tiga],['header_empat',$rowempat->header_empat]])->orderby('id','asc')->get();
                                    @endphp
                                    ...
                                    <td class="pl-5">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary"
                                                onclick="tampilgrafik({{$rowlima->id}},{{$tahunawal}},{{$tahunakhir}})">
                                                <i class="fas fa-chart-bar"></i>
                                            </button>
                                        </td>
                                    </tr>
...
function tampilgrafik(kode, tahunawal, tahunakhir) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: '/kesehatan/cari-grafik/' + kode + '/' + tahunawal + '/' + tahunakhir,
