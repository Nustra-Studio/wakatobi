    ...
    <section class="text-center mb-0" style="padding-bottom:15%;">
        <div class="container text-left">
            <div class="rows" style="padding-top:10%;">
                <div class="col-12">
                <h1>Data Pendidikan Tahun {{$tahunawal}} - {{$tahunakhir}}</h1>
                                ...
                                <table id="list-data" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" onclick="tampilgrafik({{$rowdua->id}},{{$tahunawal}},{{$tahunakhir}})">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" onclick="tampilgrafik({{$rowtiga->id}},{{$tahunawal}},{{$tahunakhir}})">
                                                <i class="fas fa-chart-bar"></i>
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" onclick="tampilgrafik({{$rowempat->id}},{{$tahunawal}},{{$tahunakhir}})">
                                                <i class="fas fa-chart-bar"></i>
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="pl-5">
                                                <span
                                                    style="margin-left:80px;">{{$isatu-1}}.{{$idua-1}}.{{$itiga-1}}.{{$iempat-1}}.{{$ilima++}}
                                                    {{$newexinput[0]}}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" onclick="tampilgrafik({{$rowlima->id}},{{$tahunawal}},{{$tahunakhir}})">
                                                <i class="fas fa-chart-bar"></i>
                                                </button>
                                            </td>
                                        </tr>
...
function tampilgrafik(kode,tahunawal,tahunakhir) {
    ...
    $.ajax({
        type:'GET',
        dataType:'json',
        url: '/pendidikan/cari-grafik/'+kode+'/'+tahunawal+'/'+tahunakhir,
