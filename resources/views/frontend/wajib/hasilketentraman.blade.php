    ...
    <section class="text-center mb-0" style="padding-bottom:15%;">
        <div class="container text-left">
            <div class="rows" style="padding-top:10%;">
                <div class="col-12">
                <h1>Data Ketentraman dan Ketertiban Tahun {{$tahunawal}} - {{$tahunakhir}}</h1>
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">List Data Ketentraman dan Ketertiban</h3>
...
function tampilgrafik(kode, tahunawal, tahunakhir) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: '/ketentraman-ketertiban/cari-grafik/' + kode + '/' + tahunawal + '/' + tahunakhir,
